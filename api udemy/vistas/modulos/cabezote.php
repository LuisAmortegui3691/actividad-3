...
<header class="container-fluid bg-dark">
	<div class="container">
		<div class="row">
			<div class="col-12 col-sm-3 col-lg-2 py-1 py-sm-3 text-white">
				<h4><span class="info-logo">Aca va tu logo</span></h4>
			</div>
			...
			</div> <!-- Redes sociales TOP -->

			<!-- Ingreso de usuarios TOP -->
			...
			</div> <!-- Ingreso de usuarios TOP -->

			<!-- Redes sociales e ingresos de usuario BOTTOM -->
			<div class="fixed-bottom bg-dark d-lg-none text-center pt-2 row">
				...
				</ul> <!-- Redes sociales BOTTOM -->
	
				<!-- Ingreso de usuario BOTTOM -->
				<ul class="list-inline col-12 col-sm-6 mb-0">
					<li class="list-inline-item text-white small">
						Ingresar
					</li>
				...
				</div>	<!-- Botones de idioma -->
			</div> <!-- Redes sociales e ingresos de usuario BOTTOM -->	
		</div>
	</div>
</header>
			...
			<div class="modal-body p-0">
				...
				<div class="row">
					...
					<div class="d-none d-sm-block col-12 col-sm-6 col-lg-4 bg-light p-3 pl-4">
						<h5 style="color: #19abc8;">Cursos de <span class="tituloCategoria" style="color: #19abc8;"><?php echo $categorias[0]["categoria"];  ?></span></h5>
						<hr>
					...
					<!-- Descripcion breve de categorias -->
					<div class="d-none d-lg-block col-lg-5 pt-3">
						<div class="card mr-lg-3">
							...
							<div class="card-body">
								<h5 class="card-title" style="color: #19abc8;">Cursos de <span class="tituloCategoria"><?php echo $categorias[0]["categoria"];  ?></span></h5>
								 <p class="card-text small desCategoria"><?php echo $categorias[0]["descripcion"];  ?></p>
								 <a href="#" class="btn backColor">Ver cursos</a>
							</div>
						</div>
					</div> <!-- Descripcion breve de categorias -->
				</div>
			</div>
		</div>
	</div>
</div> <!-- Ventana modal categorias -->
